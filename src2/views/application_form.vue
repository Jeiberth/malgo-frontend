<template>
    <div class="container">
        <h1 class="titulo-principal mt-5">Formulario de Aplicación para Arrendamiento</h1>
            ...
            <div class="seccion">
                ...
                <div v-for="(conviviente, i) in formData.Cohabitant" :key="i" class="conviviente" style="margin-bottom: 20px;">
                    <div class="campos-grid" style="padding: 24px;">
                        ...
                        <div class="campo">
                            <input v-model="conviviente.birthdate" type="number" :max="today" class="entrada" placeholder="Edad(años)" required>
                        </div>
  ...
  <script setup>
    ...
    const validarFormulario = async () => {
        ...
        try {
            ...
            construirFormData(formDataObj, formData.value);
  
            await axios.post('/api/solicitudes', formDataObj, {
