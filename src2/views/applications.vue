                    ...
                    <div class="col-6">
                        <div class="campo">
                            <select class="entrada" v-model="sortByInmueble" required style="background-color: #f8f5f0 ;">
                                ...
                                <option v-for="item in properties" :key="item" :value="item">{{ item }}</option>
                            </select>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-hover table-striped align-middle text-center custom-big-table" style="border-radius: 25px; overflow: hidden;">
                            ...
                            <tbody>
                                ...
                                <!-- Aplicante Principal -->
                                    ...
                                    <!-- Co-solicitantes -->
                                    <td>
                                        <div v-if="item.FinancialResponsible.length > 1">
                                            <i class="fa-solid fa-handshake mr-1" style="color: black"></i>
                                            {{ item.FinancialResponsible.length - 1 }}
                                        </div>
                                    </td>
                                    ...
                                    <!-- Ingreso Total -->
                                    <td>
                                        {{ formatCurrency(totalIncome(item.FinancialResponsible)) }}
                                    </td>

                                    <!-- Mascotas -->
                                    <td>
                                        <span v-for="(pet, index) in item.Pet" :key="index" class="mx-1">
                                        <i :class="getPetIcon(pet.type)"
                                            :style="{ color: pet.sex === 'Macho' ? '#007bff' : '#e83e8c' }"></i>
                                        </span>
                                    </td>
                                    ...
                                    <td >
                                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0px; justify-items: center;">
                                            <span v-for="(coh, index) in item.Cohabitant"
                                                :key="index"
                                                class="occupation"
                                    ...
                                    <!-- Parqueadero -->
                                    <td>
                                        <span v-for="(park, index) in item.ParkingNeed" :key="index" class="mx-1">
            ...
            <div class="col-12 mb-3 d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button
                        ...
                        @click="approveTenantApplication" v-if="formData.status == 'Pendiente' || formData.status == 'Pendiente Rechazado'">
                        Aprobar solicitud
                    </button>
                    <button
                        style="background-color: #dc3545; color: white; border: none; padding: 8px 16px; border-radius: 25px; font-weight: 600;"
                        @click="denyTenantApplication" v-if="formData.status == 'Pendiente' || formData.status == 'Pendiente Rechazado'">
                        Denegar solicitud
                    </button>
                </div>
            </div>
                ...
                <div class="formulario" >
                    ...
                    <div class="seccion" v-for="(responsable, index) in formData.FinancialResponsible" :key="index">
                        ...
                        <div class="contenedor-campos">
                                        ...
                                        <table class="table table-striped custom-border-table table-bordered table-docs" style="border-radius: 25px; overflow: hidden;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: auto;">
                                                        <a v-if="responsable.document_id" @click.prevent="openModal(responsable.document_id, `Documento de identidad`)">
                                                ...
                                                <template v-if="responsable.employment_status === 'Empleado'">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a v-if="responsable.document_certf" @click.prevent="openModal(responsable.document_certf, `Certificado laboral`)">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr v-for="n in 3" :key="n">
                                                        ...
                                                        <td>
                                                            <a v-if="responsable[`document_pay_${n}`]" @click.prevent="openModal(responsable[`document_pay_${n}`], `Desprendible de pago ${n}`)">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                ...
                                                <template v-else-if="responsable.employment_status === 'Pensionado'">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a v-if="responsable.document_certf" @click.prevent="openModal(responsable.document_certf, `Constancia de Pension`)">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr v-for="n in 3" :key="n">
                                                        ...
                                                        <td>
                                                            <a v-if="responsable[`document_pay_${n}`]" @click.prevent="openModal(responsable[`document_pay_${n}`], `Extracto bancario ${n}`)">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                ...
                                                <template v-else>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a v-if="responsable.document_certf" @click.prevent="openModal(responsable.document_certf, `Certificado de cámara de comercio`)">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                            ...
                            <div class="grupo-campos fiador" v-if="responsable.guarantor_full_name!=null">
                                    ...
                                    <div style="overflow-x: auto;">
                                        <table class="table table-striped table-bordered custom-border-table" style="border-radius: 25px; overflow: hidden;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a v-if="responsable.guarantor_property_cert" @click.prevent="openModal(responsable.guarantor_property_cert, `Certificado de libertad`)">
                                                        <i class="fas fa-file-pdf"></i>
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <div class="grupo-campos" v-if="responsable.AdditionalIncome.length > 0">
                                ...
                                <div class="campos-grid" style="margin-top: 20px;">
                                    <div style="overflow-x: auto;">
                                        <table class="table table-striped table-bordered custom-border-table" style="border-radius: 25px; overflow: hidden; margin-bottom: 0;">
                                            ...
                                            <tbody>
                                                <tr v-for="(ingreso, i) in responsable.AdditionalIncome" :key="i">
                                                    <td>{{ ingreso.monthly_amount }}$</td>
                                                    <td>{{ ingreso.description }}</td>
                                                    <td>
                                                        <a v-if="ingreso.income_cert" @click.prevent="openModal(ingreso.income_cert, `Certificado de ingreso`)">
                                                            <i class="fas fa-file-pdf"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                        ...
                        <div class="campos-grid" style="padding: 24px; margin-top: 20px;">
                            <div style="overflow-x: auto;">
                                <table class="table table-striped table-bordered custom-border-table" style="border-radius: 25px; overflow: hidden; margin-bottom: 0px;">
                                    ...
                                    <tbody>
                                        <tr v-for="(conviviente, i) in formData.Cohabitant" :key="i">
                    ...
                    <div class="seccion" v-if="formData.Pet.length > 0">
                        ...
                        <div class="campos-grid" style="padding: 24px; margin-top: 20px;">
                            <div style="overflow-x: auto;">
                                <table class="table table-striped table-bordered custom-border-table" style="border-radius: 25px; overflow: hidden; margin-bottom: 0px;">
                                    ...
                                    <tbody>
                                        <tr v-for="(mascota, i) in formData.Pet" :key="i">
                                            <td>{{ mascota.type }}</td>
                                            <td>{{ mascota.sex }}</td>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="seccion" v-if="formData.ParkingNeed.length > 0">
...
<script setup>
    ...
    async function approveTenantApplication(){
        ...
        if (resultado.isConfirmed) {
            ...
            await tenantApplicationResource.approveTenantApplication(tenantId.value)
                .then((response) => {
    ...
    async function denyTenantApplication(){
        ...
        if (resultado.isConfirmed) {
            ...
            await tenantApplicationResource.denyTenantApplication(tenantId.value)
                .then((response) => {
                    if(response && response.success){
                        if (response.success) {
                            allTenantApplications.value = response.data;
    ...
    const filteredTenantApplications = computed(() => {
        ...
        return allTenantApplications.value.filter(app => {
            ...
            const matchProperty = !sortByInmueble.value || sortByInmueble.value === 'Todos' || app.property_id === sortByInmueble.value;
    ...
    function countVehicles(vehicleType) {
        return formData.value.ParkingNeed.filter(parqueadero => parqueadero.vehicle_type === vehicleType).length;
    }
    ...
    function totalIncome(financials) {
        return financials.reduce((sum, f) => {
            ...
            let additional = f.AdditionalIncome?.reduce((acc, inc) => acc + parseFloat(inc.monthly_amount || 0), 0) || 0;
    ...
    function getPrincipal(item) {
        return item.FinancialResponsible.find(fr => fr.principal);
    }
    ...
    const statuses = ref(["Todos", "Pendiente", "Pendiente Rechazado", "En Curso", "Terminado" ]);
    const properties = ref(["Todos", "SE-APTO-201", "SE-APTO-202", "SE-APTO-301", "SE-APTO-302", "SE-APTO-401", "SE-APTO-402", "SE-APTO-501", "SE-APTO-502", "SE-PARQ-A1", "SE-PARQ-A2", "SE-PARQ-B1", "SE-PARQ-B2", "SE-PARQ-C1", "SE-PARQ-C2","SE-PARQ-D1", "SE-PARQ-D2", "SE-LOC-1", "FO-APTO-201", "FO-APTO-301", "FO-PARQ-1", "FO-PARQ-2", "PE-APTO-101", "PE-APTO-102", "PE-APTO-103", ]);
    ...
    const statuse = ["Pendiente", "Pendiente Rechazado", "En Curso", "Terminado"];
    ...
    function createApplication(id) {
        ...
        const financials = Array.from({ length: financialCount }).map((_, i) => ({
            ...
            principal: i === 0,
            AdditionalIncome: Math.random() > 0.4 ? [
            {
        ...
        return {
            ...
            FinancialResponsible: financials,
            Cohabitant: Array.from({ length: Math.floor(Math.random() * 6 + 1) }).map((_, i) => ({
            ...
            Pet: Array.from({ length: Math.floor(Math.random() * 4) }).map(() => ({
            type: getRandomItem(pet_types),
            sex: getRandomItem(pet_sexes)
            })),
            ParkingNeed: Array.from({ length: Math.floor(Math.random() * 3) }).map(() => ({
